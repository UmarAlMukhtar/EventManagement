      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/">
              <h3 className="text-2xl font-bold text-blue-400 mb-4 hover:text-blue-300 transition-colors">
                Event Management
              </h3>
            </Link>
            <p className="text-gray-300 mb-4 max-w-md">
              Your comprehensive solution for managing events, registrations, attendance tracking, and feedback collection.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/events" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Events
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/register" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Register
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/help" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Help Center
                </a>
              </li>
              <li>
